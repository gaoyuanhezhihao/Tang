...
class CarSocketAdmin(CarAdmin):
    def __init__(self, name, ServerIP, ServerPort, ID):
        ...
        self.port_mpu6050 = serial.Serial("/dev/ttyUSB1", 9600)
        self.angle = 0
...
#                     del self.RcvBuffer[0]
    ...
    def ReadMPU6050(self):
        while True:
            ...
            # print "ReadMPU6050 reading serial..."
            RcvByte = self.port_mpu6050.read()
            # print "ReadMPU6050 read over"
            ...
            if ord(RcvByte) == 0x55:
                ...
                if ord(Rcv_Buffer[0]) == 0x53:
                    ...
                    #     last_time = time()
                    #     print angle, '\n'
            # logger.info("ReadMPU6050: self.Order_Sock_MPU6050="+str(self.Order_Sock_MPU6050))
            # print "ReadMPU6050: self.Order_Sock_MPU6050="+str(self.Order_Sock_MPU6050)

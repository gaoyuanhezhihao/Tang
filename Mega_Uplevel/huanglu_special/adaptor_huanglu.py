...
PULSES_PER_DEGREE = 1520.0/90.0
PULSES_PER_cm = 65.57
PULSES_STD = 50
TURN_SPEED = 0.1
GoSPEED = 0.3
Valid_replies = ["D_ok","y_ok", "z_ok" , "D_ack", "s_ack", "f_ack", "b_ack", "g_ack", "w_ack", "l_ack", "r_ack", ]
order_map = {'l':'y', 'r':'z'}
order_remap = {'y':'l', 'z': 'r'}
        ...
        while True:
            ...
            while True:
                try:
                    ...
                    if command_tokens[0] in ['g', 'w', 'f', 's', 'b']:
